...
public enum UserErrorCode implements ErrorCode {
    ...
    USER_REFRESHTOKEN_NOT_MATCH(HttpStatus.BAD_REQUEST, "USER_ERROR_400", "다시 로그인 부탁드립니다"),
    USER_REFRESHTOKEN_EXPIRED(HttpStatus.BAD_REQUEST, "USER_ERROR_400", "다시 로그인 부탁드립니다");
